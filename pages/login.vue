<template>
  ...
  <div class="w-full mx-auto space-y-5 sm:w-8/12 md:w-6/12 lg:w-4/12 xl:w-3/12">
    ...
    <div class="pb-6 space-y-2 border-b border-gray-200">
      ...
      <a href="#" class="w-full py-3 btn btn-icon btn-dark">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="mr-1">
          <path
    ...
    <form class="space-y-4">
      ...
      <input type="submit" class="w-full py-3 btn btn-primary" value="Continue with email" />
    </form>
    <div class="my-2 text-center">
      <a href="#" class="text-sm text-gray-700 underline hover:text-purple-700">Forgot password</a>
    </div>
  </div>
</section>
