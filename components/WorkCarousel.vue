...
<section class="px-4 py-3 mx-auto max-w-7xl">
  ...
  <div class="grid flex-col-reverse items-center grid-cols-1 md:grid-cols-2 gap-y-10 md:gap-y-32 gap-x-10 md:gap-x-24">
    ...
    <div class="w-full h-auto bg-gradient-to-r from-primary via-secondary to-accent">
<img src="https://i.ibb.co/3yBnCfF/supershot-3-removebg-preview.png" alt=""></div>
  </div>
...
<div class="py-6 container mx-auto grid justify-center grid-cols-2 text-center lg:grid-cols-3">
			<div class="flex flex-col justify-start m-2 lg:m-6">
				...
				<p class="text-sm sm:text-base">Revenue Generated</p>
			</div>
			<div class="flex flex-col justify-start m-2 lg:m-6">
				<p class="text-4xl font-bold leading-none lg:text-6xl">$750k</p>
				<p class="text-sm sm:text-base">Ad Spend</p>
			</div>
			<div class="flex flex-col justify-start m-2 lg:m-6">
   ...
   <div class=" p-4 container shadow-md flex-grow dark:bg-coolGray-900 dark:text-coolGray-100">
	<div class="flex justify-between pb-4 border-bottom">
		<div class="flex items-center">
			<a href="#" class="mb-0 capitalize dark:text-coolGray-100">Case Study</a>
		</div>
		<NuxtLink to="/project">See All</NuxtLink>
	</div>
	<div class="space-y-4">
		<div class="space-y-2">
